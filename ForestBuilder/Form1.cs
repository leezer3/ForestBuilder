...
namespace ForestBuilder
{
    public partial class Form1 : Form
    {
        ...
        private void SetGenerator(Generator generator)
        {
            ...
            {
                dataGridView1.Rows.Add(a.Distance.ToString(invariantCulture), a.XOffset.ToString(invariantCulture),
                    a.ZOffset.ToString(invariantCulture), string.Join("; ", a.Indices), a.Height.ToString(invariantCulture),
                    a.YRotationMin.ToString(invariantCulture), a.YRotationMax.ToString(invariantCulture));
            }
        }
